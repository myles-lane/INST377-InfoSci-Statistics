...
summary(pizza[, c("annual.franchise.fee", "startup.cost")])
cor.test(pizza$startup.cost, pizza$annual.franchise.fee)
...
summary(wellwater[, c("ph", "bicarbonate.ppm")])
cor.test(wellwater$bicarbonate.ppm, wellwater$ph)
...
summary(cricket[, c("chirps.sec", "temp.f")])
...
#summary of data
attach(USArrests)
summary(USArrests[, c("UrbanPop", "Murder", "Assault", "Rape")])

#check correlations
cor.test(UrbanPop, Murder)
cor.test(UrbanPop, Assault)
cor.test(UrbanPop, Rape)

#regression
summary(lm(Murder ~ UrbanPop))
summary(lm(Assault ~ UrbanPop))
summary(lm(Rape ~ UrbanPop))

# Modify the code below to create your plots
# You may customize it as much as you like

#Murder
plot(UrbanPop, Murder,  # change IV & DV to your variables
     pch = 16, 
     cex = 1.3, 
     col = "blue", #optional: change color of your plotted dots
     main = "Urban Population vs Murder Arrests",   # edit to  change your plot title
     xlab = "Population", # edit title of your x-axis
     ylab = "Murder Arrests") # edit title of your y-axis
abline(lm(Murder ~ UrbanPop, data = USArrests))  # change DV & IV to your variables.

#Assault
plot(UrbanPop, Assault,  # change IV & DV to your variables
     pch = 16, 
     cex = 1.3, 
     col = "red", #optional: change color of your plotted dots
     main = "Urban Population vs Assault Arrests",   # edit to  change your plot title
     xlab = "Population", # edit title of your x-axis
     ylab = "Assault Arrests") # edit title of your y-axis
abline(lm(Assault ~ UrbanPop, data = USArrests))  # change DV & IV to your variables.

plot(UrbanPop, Rape,  # change IV & DV to your variables
     pch = 16, 
     cex = 1.3, 
     col = "black", #optional: change color of your plotted dots
     main = "Urban Population vs Rape Arrests",   # edit to  change your plot title
     xlab = "Population", # edit title of your x-axis
     ylab = "Rape Arrests") # edit title of your y-axis
